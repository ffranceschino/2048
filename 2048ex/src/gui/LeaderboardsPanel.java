...
public class LeaderboardsPanel extends GuiPanel {
    ...
    private final int backButtonWidth = 220;
    private final int buttonSpacing = 20;
    private final int buttonY = 120;
    private final int buttonHeight = 50;
    private final int leaderboardsX = 130;
    private final int leaderboardsY = buttonY + buttonHeight + 90;
    private final String title = "Leaderboards";
    private final Font titleFont = Game.MAIN.deriveFont(48f);
    private final Font scoreFont = Game.MAIN.deriveFont(30f);
